...
#+REVEAL_TITLE_SLIDE: <div style="float:left"><a href="https://containerplumbing.org/" target="_blank"><img src="./media/container-plumbing-days-logo-horizontal-darkbg.svg" height="75px" style="margin-bottom:30px"/></a></div>
